        ...
        <tbody>
            @foreach($data as $item)
                <tr>
                    ...
                    <form id="deleteForm{{ $item->id }}" action="{{ route('admin.deleteakun', $item->id) }}" method="post" style="display: none;">
                        @csrf
                        @method('DELETE')
                    </form>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 60%;" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Formulir edit -->
                    <form method="POST" action="{{ route('admin.editakun', $item->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" value="{{ $item->password }}" class="form-control" required>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="alat{{ $item->id }}">alat:</label>
